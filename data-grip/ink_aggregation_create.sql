...
ALTER TABLE
    "User" ADD CONSTRAINT "user_id_foreign" FOREIGN KEY("id") REFERENCES "Artist"("user_id");
ALTER TABLE
    "Artist" ADD CONSTRAINT "artist_post_foreign" FOREIGN KEY("post") REFERENCES "Post"("id");
ALTER TABLE
    "Studio" ADD CONSTRAINT "studio_staff_foreign" FOREIGN KEY("staff") REFERENCES "User"("id");
ALTER TABLE
    "Studio" ADD CONSTRAINT "studio_owner_foreign" FOREIGN KEY("owner") REFERENCES "User"("id");